...
export const Postview = ({ user, time, avatar, postimage }) => {
  return (
    <div className="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
      ...
      <div className="card-body px-3 mt-3" onClick={() => { }}>
        <p
          className={`fw-500 text-grey-500 font-xssss w-100 mb-2 leading-6 relative ${isShowMore ? "h-fit" : "h-12 overflow-hidden"
            }`}
        >
          {des}{" "}
          <a
            className={`fw-600 text-primary mr-2 cursor-pointer float-right absolute right-0 bg-white px-2 ${isShowMore ? "bottom-0" : "top-6"
              }`}
          >
